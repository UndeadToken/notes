...
- You an retrieve the IAM Role name from the metadata, but you CANNOT retrieve the IAM Policy  
...
The CLI will look for credentials in this order:  
    ...
    - Environment variables — AWS_ACCESS_KEY, AWS_SECRET_KEY, and AWS_SESSION_TOKEN  
...
AWS Signature v4 Signing (Sigv4)  
    ...
    - When you call the AWS HTTP API, you sign the request s that AWS can identify you, using your AWS credentials (access key & secret key)  
