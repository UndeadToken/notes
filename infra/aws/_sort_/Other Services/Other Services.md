...
- Partition datasets in s3 for easy querying on virtual columns  
    - [s3://yourBucket/pathToTable](s3://yourBucket/pathToTable)  
        - /<PARTITION_COLUMN_NAME>=<VALUE>  
            - ...  
        - e.g. [s3://athena-examples/flight/parquet/year=1991/month=1/daty=1/](s3://athena-examples/flight/parquet/year=1991/month=1/daty=1/)  
